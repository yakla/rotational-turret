...
first i started the project as a idea for a consept for a rotating turret that can go forever without needing to retract after i designed the base and then decited to go all out and make a follower cammera. for me its just a fun project to do in the meantime of the war currently. 
...
- [v] Design the project with a cheaper servo (Planned) 
